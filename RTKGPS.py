...
def payloadDecoder(decodeFormat, payload):
    decodedData = struct.unpack_from(decodeFormat[0],payload)
    decodedData = list(decodedData)
    descriptiveData = []
    for item in range(len(decodeFormat[1])):
        descriptiveData.append(decodeFormat[1][item])
        descriptiveData.append(decodedData[item])
...
def PayloadIdentifier(payload, ID, Class):
    ...
    print("id {}, class {}, length {}".format(ID, Class, length))

    CONST_UBX_ACK_ACK = "05012"
    CONST_UBX_ACK_NAK = "05002"
    CONST_UBX_AID_ALM = "0B301"
    CONST_UBX_AID_ALM2 = "0B308"
    CONST_UBX_AID_ALM3 = "0B3040"
    CONST_UBX_AID_AOP = "0B331"
    CONST_UBX_AID_AOP2 = "0b3368"
    CONST_UBX_AID_EPH = "0B311"
    CONST_UBX_AID_EPH2 = "0b318"
    CONST_UBX_AID_EPH3 = "0b3140"
    CONST_UBX_AID_HUI = "0B0272"
    CONST_UBX_AID_INI = "0B0148"
    CONST_UBX_CFG_ANT = "06134"
    CONST_UBX_CFG_BATCH = "06938"
    CONST_UBX_CFG_CFG = "060912"
    CONST_UBX_CFG_CFG2 = "060913"   
    CONST_UBX_CFG_DAT = "060644"
    CONST_UBX_CFG_DAT2 = "060652"
    CONST_UBX_CFG_DGNSS = "06704"
    CONST_UBX_CFG_HNR = "065C4"
    ...
    CONST_UBX_NAV_PVT = "010792"
    CONST_UBX_NAV_RELPOSNED = "013C40"
    ...
    base16Data = [int(x, 16) for x in payload]
    ...
    ClassIDs = {
        ...
        CONST_UBX_NAV_PVT: ("ihbbbbbbiibbbbiiiiiiiiiiiiihbbbbbbbihh",["iTOW","year","month","day","hour","min","sec","valid","tAcc","nano","fixType","flags","flags2","numSV","lon","lat","height","hMSL","hAcc","vAcc","velN","velE","velD","gSpeed","headMot","sAcc","headAcc","pDOP","reserved1","reserved1","reserved1","reserved1","reserved1","reserved1","reserved1","reserved1","reserved1","reserved1","reserved1","headVeh","magDec","magAcc"]),
    ...
    if identifier in ClassIDs.keys():
        payloadDecoder(ClassIDs[identifier],currentByteLine)
                ...
                if serialReader.in_waiting != 0:
                    ...
                    if(len(startIndices) >= 2):
                        for currentStartIndex in range(len(startIndices)-1):
                            # For all indexes for start points, check if each is a full line.
